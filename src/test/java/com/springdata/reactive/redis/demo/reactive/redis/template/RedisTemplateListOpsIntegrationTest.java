package com.springdata.reactive.redis.demo.reactive.redis.template;

import com.springdata.reactive.redis.demo.reactive.redis.SpringRedisReactiveApplication;
...
public class RedisTemplateListOpsIntegrationTest {
  ...
  public static void startRedisServer() throws IOException {
    redisServer = new RedisServerBuilder().port(6378).setting("maxmemory 128M").build();
    redisServer.start();
  }
